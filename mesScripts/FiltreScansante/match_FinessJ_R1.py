...
OUTPUT=r"C:\Users\LeviWEBERT\OneDrive - ALBUS PARTNERS\Bureau\Scan Medecine\TABLEAU à TRAIté\Result_Algo_R1.xlsx"
...
print(f"R1 appliqué : excel généré à {OUTPUT}")